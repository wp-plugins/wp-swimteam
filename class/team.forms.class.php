...
/**
 *
 * $Id: team.forms.class.php 1065 2014-09-22 13:04:25Z mpwalsh8 $
 *
...
class WpSwimTeamTeamProfileForm extends WpSwimTeamForm
{
    ...
    function form_init_elements()
    {
        ...
        $coach = new FEWPUserListBox('Coach', false, '200px') ;
        $this->add_element($coach) ;
    }
    ...
    function form_init_data()
    {
        ...
        $this->set_element_value('Coach', $p->getCoachUserId()) ;
    }
    ...
    function form_content()
    {
        ...
        $table->add_row($this->element_label('Coach'),
            $this->element_form('Coach')) ;
    ...
    function form_action()
    {
        ...
        $p->setCoachUserId($this->get_element_value('Coach')) ;
