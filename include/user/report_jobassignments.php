 ...
 *
 * $Id: report_jobassignments.php 1082 2015-07-03 18:59:41Z mpwalsh8 $
 *
 ...
 */
class ReportJobAssignmentsTabContainer extends SwimTeamTabContainer
{
    /**
     * Build Instructions
     *
    ...
    function __buildInstructions()
    {
        ...
        $div->add('Generate a report of the Job assignments for one or more swim meets.
            ...
            a subset of the assignments based on the job duration or job type.') ;
     ...
     *
     */
    function ReportJobAssignmentsTabContainer()
    {
