...
/**
 * Roster Export CSV page content.
 *
 * $Id: rosterCSV.php 849 2012-05-09 16:03:20Z mpwalsh8 $
 *
...
if (!empty($args))
{
    ...
    if (array_key_exists("file", $args))
    {
        ...
        header("Content-disposition:  attachment; filename=SwimTeamRoster-" .  date("Y-m-d").".csv") ;
        print $csv ;
    }
    else
    {
